  ...
  return (
    <section className="rounded-3xl border border-[#EEEAE1] bg-white p-6 sm:p-8 shadow-xs text-left space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3.5">
        ...
        <div className="p-4 rounded-2xl bg-[#FEF2F2] border border-[#FECDD3] space-y-1.5">
      ...
      <div className="space-y-4 pt-2">
        ...
        <div className="space-y-3">
          {analytics.map((item) => (
            <div
              key={item.domain}
              className="p-3.5 rounded-xl border border-[#EEEAE1] bg-[#FAF9F5] hover:bg-white hover:border-[#B5A886] transition-all space-y-2"
            >
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1 text-[13px]">
                <div className="flex items-center gap-2.5">
                  ...
                  />
                  <strong className="text-[#1D2522] font-bold font-sans">
                    {item.domain}
                  </strong>
