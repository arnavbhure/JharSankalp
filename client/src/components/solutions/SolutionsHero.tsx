...
import { ArrowDown, CheckCircle2, Rocket, TrendingUp, Plus } from 'lucide-react';

interface SolutionsHeroProps {
  onExploreClick: () => void;
}

export function SolutionsHero({ onExploreClick }: SolutionsHeroProps) {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center">
          ...
          <div className="lg:col-span-7 space-y-5">
            ...
            <h1 className="text-[2.5rem] sm:text-[3.2rem] lg:text-[3.5rem] font-extrabold text-[#1D2522] tracking-tight leading-[1.1] font-sans">
              Ideas become meaningful when they{' '}
              <span className="text-[#F5A623]">reach the ground.</span>
            </h1>
          ...
          {/* ── Right Column: Compact Visual Progress Summary (5 Cols) ── */}
