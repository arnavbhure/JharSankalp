...
export function PanelHeader({
  ...
  return (
    <div
      className={cn(
        'flex items-start justify-between gap-3 border-b border-neutral-200 pb-3 mb-3',
        className,
      )}
    >
      <div className="space-y-0.5">
        ...
        {description && <p className="text-small text-neutral-600 leading-normal">{description}</p>}
      </div>
...
export function PanelFooter({
  ...
  return (
    <div
      className={cn(
        'mt-4 pt-3 border-t border-neutral-200 flex items-center justify-between text-small text-neutral-600',
        className,
      )}
    >
      {children}
