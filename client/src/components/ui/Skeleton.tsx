...
export function Skeleton({ className }: { className?: string }) {
  return (
    <div className={cn('animate-pulse rounded-sm bg-neutral-200', className)} aria-hidden="true" />
  );
}
...
export function SkeletonPanel() {
  return (
    <div
      className="rounded-sm border border-neutral-200 bg-neutral-0 p-4 space-y-3"
      aria-hidden="true"
    >
  ...
  return (
    ...
    >
      ...
      <div className="space-y-1">
        ...
        {submessage && <p className="text-caption text-neutral-600">{submessage}</p>}
      </div>
    </div>
  );
}
