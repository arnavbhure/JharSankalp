...
export function CollaborationSection({
  ...
  return (
    ...
    >
      ...
      {/* Stakeholder Columns or Empty State */}
      {challenge.stakeholders && challenge.stakeholders.length > 0 ? (
            ...
            return (
              ...
              >
                <div className="space-y-4">
                  ...
                  <div className="border-b border-[#EEEAE1] pb-3 space-y-1">
                    <div className="flex items-center gap-2">
                      ...
                      group.categoryName.includes('Academic') ? (
                ...
                <div className="pt-2 text-[11px] font-mono text-[#6B5845]/70">
                  Participation registered through JharSankalp Consortium Framework
                </div>
              </div>
            );
          })}
        ...
        <div className="rounded-2xl border border-dashed border-[#EEEAE1] bg-white p-8 sm:p-10 text-center space-y-4 max-w-2xl mx-auto">
          <div className="h-12 w-12 rounded-full bg-[#FAF9F5] text-[#123B2A] border border-[#EEEAE1] flex items-center justify-center mx-auto">
            <Users className="h-6 w-6 text-[#123B2A]" />
          </div>
          <div className="space-y-1">
            <h3 className="text-[1.15rem] font-bold text-[#1D2522]">
              Consortium Formation in Progress
            </h3>
            <p className="text-[13.5px] text-[#6B5845] max-w-md mx-auto leading-relaxed">
              Academic research cells, technical institutes, and community organizations are being invited to form a dedicated working group for this challenge.
            </p>
          </div>
          <button
            onClick={onJoinCollaboration}
            className="inline-flex items-center gap-2 rounded-lg border border-[#123B2A] bg-white hover:bg-[#F8F6F1] text-[#123B2A] px-5 py-2.5 text-[13.5px] font-bold shadow-2xs transition-all active:scale-[0.98] cursor-pointer"
          >
            <Users className="h-4 w-4 text-[#123B2A]" />
            <span>Join Working Group</span>
          </button>
